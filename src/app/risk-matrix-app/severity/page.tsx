  ...
  return (
    <Card className="w-full max-w-3xl">
      ...
      <CardContent>
        <ChartContainer
          config={{
            "Dataset A": { label: "Dataset A", color: "#5E1675" },
            "Dataset B": { label: "Dataset B", color: "#EE4266" },
            "Dataset C": { label: "Dataset C", color: "#FFD23F" },
            "Dataset D": { label: "Dataset D", color: "#072541" },
            "Dataset E": { label: "Dataset E", color: "#D71313" },
          }}
          className="h-[400px]"
        >
