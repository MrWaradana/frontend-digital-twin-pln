...
import { MenuConfig, MenuGroup } from "./types";


export function generateMenuList(pathname: string, menuConfig: MenuConfig): MenuGroup[] {
  return menuConfig.groups.map(group => ({
    groupLabel: group.groupLabel,
    menus: group.menus.map(menu => ({
      ...menu,
      active: menu.exactMatch
        ? pathname === menu.href
...
export function Menu(props: MenuProps) {
  ...
  const { isListOpen, menuConfig } = props;

  const menuList = generateMenuList(pathname, menuConfig);
