    ...
    <>
      ...
      <nav className="mt-8 h-full w-full overflow-hidden">
        <ul className="flex flex-col min-h-[calc(100vh-48px-36px-16px-32px)] lg:min-h-[calc(100vh-32px-40px-32px)] items-start space-y-1 px-2">
                        ...
                        <Tooltip delayDuration={100}>
                          <TooltipTrigger asChild>
                            <Button
                              ...
                              className={`w-full justify-start h-10 mb-1 hover:bg-white rounded-xl hover:shadow-xl ${
                                active ? "rounded-xl shadow-xl bg-white" : ""
                              }`}
                              asChild
                            >
                              <Link href={href}>
                                ...
                                >
                                  <Icon size={18} className="text-[#1C9EB6]" />
                                </span>
                                <p
                                  className={cn(
          ...
          <li className="w-full grow flex items-end -translate-y-4">
            <ModeToggle />
          </li>
        </ul>
      </nav>
